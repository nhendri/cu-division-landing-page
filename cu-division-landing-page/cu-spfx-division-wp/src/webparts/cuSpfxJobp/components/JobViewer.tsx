...
import TableFilters, {ITableFilterProps, IMenuOptions} from './SFComponents/TableFilters';
...
// default class internal state
export interface IJobVewerState {
    isLoading: boolean;
    menuState: {
...
export default class JobViewer extends React.Component<IJobViewerProps,
    ...
    // child prop methods
    protected menuDropdownEvent(e: any): void {
        ...
        if(target.id === 'cuArrCities'){
            filters.selectedCity = target.value;
        };        
        if(target.id === 'cuArrDepartments'){
            filters.selectedDept = target.value;
        };        
    ...
    protected menuResetEvent(e: any): void {
        const filters: IMenuFilters = {
            ...this.state.menuState.filters,
            applied: false,
            filteredData: undefined,
    ...
    protected tableClickRowEvent(e: any): void {
        const target = e.target as HTMLInputElement;
    ...
    protected jobSummaryCloseEvent(e: any): void {
        this.setState({
            ...this.state, jobSummaryState: {
                ...this.state.jobSummaryState,                
                selectedJob: testJobData,
